  ...
  return (
    <div className="boxed-display">
      <div className="content" >
        <h1 style={{ fontFamily: "Magilio", fontSize: "48px" }}>Introducing GoGreen 365,<br />a pathway towards sustainable living</h1>
      </div>
    </div>
  );
}
...
const BodyParagraph = () => {
  return (
    ...
    <div className='Container mt-3 mb-5 mx-4'>
      ...
      <p className='paragraph'>Join us on this journey towards a greener and more sustainable future. Register at GoGreen 365 today and start making a difference, one day at a time. </p>
      <h3 className='text-center my-4 custom-green' style={{ fontFamily: "Magilio", textDecoration: "underline" }}>Together, we can shape a better world for ourselves and future generations.</h3>
    </div>
